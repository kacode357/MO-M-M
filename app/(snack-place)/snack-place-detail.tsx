...
const SnackPlaceDetail = () => {
  ...
  const [snackPlace, setSnackPlace] = useState<SnackPlaceDetailData | null>(
    null
  );
            ...
            <View style={styles.paddedContent}>
                  ...
                  <View style={styles.ratingRowContainer}>
                    <View style={styles.ratingRow}>
                      ...
                      <ThemedText style={styles.ratingText}>
                        ...
                        {ratingData.totalRatingsCount} đánh giá)
                      </ThemedText>
                    </View>
                        ...
                        <View style={styles.barContainer}>
                          <View
                            style={[
                              ...
                              {
                                width: `${
                                  ratingData.ratingDistributionPercent[
                                    star.toString()
                                  ]
                                }%`,
                              },
              ...
              <View style={styles.detailRow}>
                ...
                <ThemedText style={styles.detail}>
                  {formatTime(snackPlace.openingHour)}
                </ThemedText>
              </View>
              <TouchableOpacity
              ...
              {activeTab === "overview" ? (
                <View style={styles.tabContent}>
                  <ThemedText style={styles.description}>
                    {snackPlace.description || "Không có mô tả"}
                  </ThemedText>
                </View>
              ) : (
                <View style={styles.tabContent}>
...
const styles = StyleSheet.create({
  ...
  tabContainer: {
    ...
    marginVertical: 10,
    borderBottomWidth: 1,
    borderBottomColor: Colors.light.primaryText,
  },
  tab: {
    flex: 1,
    paddingVertical: 10,
